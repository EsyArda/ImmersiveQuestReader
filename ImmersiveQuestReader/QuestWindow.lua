...
function QuestWindow:Constructor(debug, x_pos, y_pos)
   ...
   quest_window.window:SetSize(800, 300); -- TODO en % de la taille de lՎcran
   quest_window.window:SetPosition(x, y);
   quest_window.window:SetMouseVisible(true);
   quest_window.window:SetText("0 - Quest Name (1/1)");
   quest_window.window:SetVisible(true); --false -- Hidden by default
